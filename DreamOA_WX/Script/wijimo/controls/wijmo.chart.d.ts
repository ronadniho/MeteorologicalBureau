...
declare module wijmo.chart {
    ...
    */
    class FlexChartBase extends Control implements _IPalette {
        ...
        * required by the axis labels, but you can override it in case you want
...
declare module wijmo.chart {
    ...
    */
    class FlexPie extends FlexChartBase {
        ...
        public _sum: number;
        /**
        * Initializes a new instance of a @see:FlexPie control.
        *
        ...
        */
        ...
        /**
        * Gets or sets the name of the property that contains the name of data item.
        */
        ...
        */
        ...
        /**
        * Gets or sets the offset of slice from the pie center.
        *
        */
        public offset : number;
        /**
        * Gets or sets the inner radius(hole radius).
        *
        */
        public innerRadius : number;
        /**
        * If true, draws pie slices counterclockwise. The default is to draw clockwise.
        *
        */
        public reversed : boolean;
        /**
        * Gets or sets the position of selected pie slice.
        *
        */
        public selectedItemPosition : Position;
        /**
        * Gets or sets the offset of selected slice from pie center.
        *
        */
        public selectedItemOffset : number;
        /**
        * Enables selection animation.
        *
        */
